<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users" aria-hidden="true"></i> Manajemen Tamu
        <small>Tambah, Ubah, Hapus</small>
        <span class='pull-right'><a class="btn btn-primary" href="<?php echo base_url(); ?>addNewCustomer"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Tamu Baru</a></span>
      </h1>
    </section>
