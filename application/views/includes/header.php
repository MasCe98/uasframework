    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo base_url(); ?>" class="logo">
          ...
          <span class="logo-mini"><b>HABCY</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>HOTEL ABCY </b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              <li class="dropdown user user-menu">
                <a href="<?php echo base_url(); ?>addNewBooking" class="bg-primary">
                  <span><i class="fa fa-plus"></i><b> Tambah Booking Baru</b></span>
                </a>
              <li>
              ...
              <ul class="treeview-menu menu-open">
                ...
                <li>
                  <a href="<?php echo base_url(); ?>roomSizesListing" >
                    <i class="fa fa-circle-o"></i> Tipe Kamar
                  </a>
                </li>
                
                <li>
                  <a href="<?php echo base_url(); ?>roomListing" >
                    <i class="fa fa-circle-o"></i> Kamar 
                  </a>
                </li>
                <li>
                  <a href="<?php echo base_url(); ?>baseFareListing" >
                    <i class="fa fa-circle-o"></i> Edit Tarif Dasar
                  </a>
                </li>
