...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Hotel ABCY | Lupa Password</title>
  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="#"><b>Hotel ABCY</b><br>System Informasi Reservasi Hotel</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <form action="<?php echo base_url(); ?>resetPasswordUser" method="post">
          <div class="form-group has-feedback">
            <input type="email" class="form-control" placeholder="Masukkan Email" name="login_email" required />
