...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <a class="btn btn-primary btn-lg hidden-xs" href="<?= base_url(); ?>addNewBooking"><i class="fa fa-plus" aria-hidden="true"></i>Tambah Booking Baru</a>
        </span>
      </h1>
    </section>
    <br>
    <section class="content">
        ...
        <form action="<?php echo base_url() ?>bookings" method="POST" id="searchList">
            <div class="row form-group">
                ...
                <div class="col-md-2">
                    <input type="text" name="customerName" value="<?= $customerName; ?>" class="form-control input-sm" placeholder="Nama Tamu" autocomplete="off" />
                </div>
                <div class="col-md-2">
                    <input type="text" name="mobileNumber" value="<?= $mobileNumber; ?>" class="form-control input-sm" placeholder="To Telp." autocomplete="off" />
            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="input-group">
                        <input type="text" id="startDate" name="startDate" value="" class="form-control input-sm" placeholder="Tahun-Bulan-Hari" autocomplete="off" />
                ...
                <div class="col-md-2">
                    <div class="input-group">
                    <input type="text" id="endDate" name="endDate" value="" class="form-control input-sm" placeholder="Tahun-Bulan-Hari" autocomplete="off" />
                        <div class="input-group-addon">
	                    	<i class="fa fa-calendar"></i>
						</div>
                    </div>
                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td width="15%" class="text-center">
                          ...
                          <a href="" data-bookingId="<?php echo $record->bookingId; ?>" class="deleteBooking btn btn-sm btn-danger" title="Delete"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                    <?php
                        }
