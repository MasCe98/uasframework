<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      <i class="fa fa-book" aria-hidden="true"></i> Manajemenen Pemesanan
        <small>Buat/Ubah Pemesanan</small>
      </h1>
    </section>
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
							    <div class="col-md-12 text-right">                                
                                    <button type="button" class="btn btn-primary btn-md" id='checkAvailableBtn'>Cek Ketersediaan</button>
                            ...
                            <div class="row">
							    <div class="col-md-6">                                
                                    <div class="form-group">
                                        <label for="roomId">No Kamar</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="customerId">Pilih Tamu/ <i class="fa fa-search"></i> Untuk Mencari)</label>
                                        <div class="input-group">
