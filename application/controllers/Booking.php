...
class Booking extends BaseController
{
    ...
    function bookings()
    {
        ...
        $this->global['pageTitle'] = 'Hotel ABCY : Pemesanan';
    ...
    {
        $this->global['pageTitle'] = 'Hotel ABCY : Pesan Kamar';
    ...
    function editOldBooking($bookingId = NULL)
    {
        ...
        $this->global['pageTitle'] = 'Hotel ABCY : Ubah Pesanan - '. $bookingDetails->customerName . ' (' . date('Y-m-d', strtotime($bookingDetails->bookStartDate)) . ' to '. date('Y-m-d', strtotime($bookingDetails->bookEndDate)) . ' )';
